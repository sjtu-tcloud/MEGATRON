...
int fpga_register_afu_mdev_device(struct platform_device *pdev)
{
    ...
    optimus->vtp= kthread_create_on_node(optimus_vtp_srv, optimus, 0,"optimus-vtp");
    kthread_bind(optimus->vtp, 0);
    wake_up_process(optimus->vtp);
#endif 
